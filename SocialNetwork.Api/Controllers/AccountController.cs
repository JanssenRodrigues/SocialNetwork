...
namespace SocialNetwork.Api.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> ResetPassword(RecoveryPassViewModel model)
        {
            ...
            var token = await UserManager.GenerateUserTokenAsync("ResetPassword", user.Id);
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            Models.ApplicationUser user = await UserManager.FindAsync(new UserLoginInfo(externalLogin.LoginProvider,
